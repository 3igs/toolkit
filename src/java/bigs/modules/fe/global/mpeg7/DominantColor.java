 ...
 * copyright notice 
 */
package bigs.modules.fe.global.mpeg7;
...
public class DominantColor implements JDomVisualDescriptor {
	bigs.modules.fe.global.mpeg7.DominantColorImplementation dc;
    private bigs.modules.fe.global.mpeg7.DominantColorImplementation.DominantColorValues dcData = null;
    ...
    public DominantColor(BufferedImage img) {
        dc = new bigs.modules.fe.global.mpeg7.DominantColorImplementation();
    ...
    public DominantColor(Element descriptor) throws VisualDescriptorException {
        ...
        if (!descriptor.getAttribute("type", xsi).getValue().equals("DominantColorType")) {
            ...
            dcData = new bigs.modules.fe.global.mpeg7.DominantColorImplementation.DominantColorValues();
